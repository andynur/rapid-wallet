...
return [
    ...
    'title' => 'Rapid Wallet API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'The Rapid Wallet API facilitates the management of user wallets with key functionalities such as deposits and withdrawals. Built with security and performance in mind, the API leverages Laravel Sanctum for authentication using api token and integrates with external payment services to handle transactions.
